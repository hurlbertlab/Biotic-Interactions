...
ggsave("Figures/Figure2.pdf", width = 16, height = 11)
...
ggsave("Figures/Figure3.pdf", height = 11, width = 16)
...
ggsave("C:/Git/Biotic-Interactions/Figures/Figure4.pdf", height = 8, width = 12)
...
ggsave("Figures/Fiugre1a.pdf", height = 8, width = 12)
...
# commented out bc takes a long time to run
noncomps_output = c()
...
ggsave("Figures/Figure5.pdf", height = 8, width = 12)
